...
namespace BG_BIM_Interface.Rhinoceros.ViewModels
{
    class BgBimInterfaceDocPanelViewModel : Rhino.UI.ViewModel
    {
        public BgBimInterfaceDocPanelViewModel(uint documentSerialNumber)
        {
            this.DocumentRuntimeSerialNumber = documentSerialNumber;
            BgBimInterfaceRhinocerosPlugIn.Instance.SettingsSaved +=
        ...
        public Rhino.PersistentSettings Settings => BgBimInterfaceRhinocerosPlugIn.Instance.Settings;
